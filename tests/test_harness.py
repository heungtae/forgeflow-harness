...
class FakeAdapter:
    def __init__(self, fail_create: bool = False, fail_run_on_task_id: str | None = None) -> None:
...
def make_config(tmp_path: Path, validation_commands: list[list[str]] | None = None) -> HarnessConfig:
    return HarnessConfig(
        ...
        validation_commands=validation_commands or [["python3", "-c", "print('validation ok')"]],
